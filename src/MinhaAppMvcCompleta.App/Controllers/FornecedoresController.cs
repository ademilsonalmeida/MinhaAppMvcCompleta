...
namespace MinhaAppMvcCompleta.App.Controllers
{
    public class FornecedoresController : BaseController
    {
        ...
        {
            var fornecedorViewModel = await ObterFornecedorEnderecoProdutos(id);
        ...
        private async Task<FornecedorViewModel> ObterFornecedorEnderecoProdutos(Guid id)
        {
